...
The p-value is over 0.5, so we do not have sufficient evidence that life expectancy equals 60.
...
The p-value is under 0.5, so we have sufficient evidence that life expectancy is less than 60.
...
The p-value is over 0.5, so we do not have sufficient evidence that life expectancy is greater than 60.
